...
class Day4(Scene):
    def construct(self):
        ...
        parabula5 = axes1.plot(lambda x: -2*x**2, color=YELLOW)
        ...
        lable7 = axes1.get_graph_label(parabula5, label="y = -2x^2")
        ...
        punkt8 = Dot(axes1.c2p(1,-2), color=RED)
        ...
        punkt_lable5 = MathTex("(1,-2)").next_to(punkt8, RIGHT)
        ...
        self.wait()
        self.play(Unwrite(punkt_lable4))
        self.wait(2)
        self.play(Transform(parabola1, parabula5), Transform(lable1, lable7), Transform(punkt3, punkt8))
        self.play(Write(punkt_lable5))
        self.wait(2)
        self.play(Uncreate(lable1), Uncreate(parabola1), Unwrite(punkt_lable5), Uncreate(punkt3), Unwrite(lable1))
        ...
        self.play(Create(smooth_line1), run_time=1.5)
        ...
        for d in dots_on_axes2:
            self.play(Create(d), run_time=0.2)
        self.play(Create(smooth_line2), run_time=1.5)
