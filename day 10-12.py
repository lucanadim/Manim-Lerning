...
class day10(Scene):
    def construct(self):
        text1_1 = Text("Parabel aufbau").scale(0.7).shift(UP*3.5, LEFT*5.3).add_background_rectangle(color=BLACK)
        text2_1 = MathTex("y = x", color=BLUE).scale(1.4).shift(UP*2, LEFT*5.2).add_background_rectangle(color=BLACK)
        text2_2 = MathTex("y = x^2", color=BLUE).scale(1.4).shift(UP*2, LEFT*5.2).add_background_rectangle(color=BLACK)
        text2_3 = MathTex("y = x^2 + 2", color=BLUE).scale(1.4).shift(UP*2, LEFT*5).add_background_rectangle(color=BLACK)
        text2_4 = MathTex("y = x^2 - 2", color=BLUE).scale(1.4).shift(UP*2, LEFT*5).add_background_rectangle(color=BLACK)
        text2_5 = MathTex("y = x^2", color=BLUE).scale(1.4).shift(UP*2, LEFT*5.2).add_background_rectangle(color=BLACK)
        text2_6 = MathTex("y = (x-3)^2", color=BLUE).scale(1.4).shift(UP*2, LEFT*5).add_background_rectangle(color=BLACK)
        text2_7 = MathTex("y = (x+3)^2", color=BLUE).scale(1.4).shift(UP*2, LEFT*5).add_background_rectangle(color=BLACK)
        text2_8 = MathTex("y = x^2", color=BLUE).scale(1.4).shift(UP*2, LEFT*5.2).add_background_rectangle(color=BLACK)
        text2_9 = MathTex(
            "y", "=", "(x-", "4", ")^2", "+", "4",
            color=BLUE
        ).scale(1.4).shift(UP*2 + LEFT*4).add_background_rectangle(color=BLACK)
        text2_9[4].set_color(YELLOW)
        text2_9[7].set_color(YELLOW)
        text2_10 = MathTex(
            "y", "=", "(x+", "2", ")^2", "-", "2",
            color=BLUE
        ).scale(1.4).shift(UP*2 + LEFT*4).add_background_rectangle(color=BLACK)
        text2_10[4].set_color(YELLOW)
        text2_10[7].set_color(YELLOW)
        ...
        text3_4 = Text("Mit diesen Regeln können wir die Parabel \nan jede Position des Koordinatensystems \nverschieben die wir möchten").scale(0.5).shift(RIGHT*3, DOWN).add_background_rectangle(color=BLACK)
        ...
        punkt1_9 = Dot(axes2.c2p(5,5), color=BLUE)
        punkt1_10 = Dot(axes2.c2p(4,4), color=YELLOW)
        punkt1_11 = Dot(axes2.c2p(-1,-1), color=BLUE)
        punkt1_12 = Dot(axes2.c2p(-2,-2), color=YELLOW)
        ...
        punkt_lable1_9 = MathTex("(5,5)", color=BLUE).next_to(punkt1_9, RIGHT)
        punkt_lable1_10 = MathTex("(4,4)", color=YELLOW).next_to(punkt1_10, RIGHT)
        punkt_lable1_11 = MathTex("(-1,-1)", color=BLUE).next_to(punkt1_11, RIGHT)
        punkt_lable1_12 = MathTex("(-2,-2)", color=YELLOW).next_to(punkt1_12, RIGHT)
        ...
        graph1_9 = axes2.plot(lambda x: (x-4)**2 + 4, color=BLUE)
        graph1_10 = axes2.plot(lambda x: (x+2)**2 - 2, color=BLUE)
        ...
        self.play(
            Create(punkt1_10),
            Create(punkt_lable1_10),
        )
        self.wait()
        self.play(
            Transform(text2_1, text2_10),
            Transform(graph1_1, graph1_10),
            Transform(punkt1_1, punkt1_11),
            Transform(punkt1_10, punkt1_12),
            Transform(punkt_lable1_1, punkt_lable1_11),
            Transform(punkt_lable1_10, punkt_lable1_12),
            run_time = 1.5
        )
        self.wait(2)
